...
public class GridBlock {
	...
	public synchronized boolean get(int threadID) throws InterruptedException { // only one thread at a time can ask a gridBlock to move into it, avoiding a data race
