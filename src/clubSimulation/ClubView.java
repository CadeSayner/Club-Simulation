...
public class ClubView extends JPanel implements Runnable {
		...
		ClubView(PeopleLocation[] custs, PeopleLocation barmanLocation, ClubGrid grid,int []exits) { //constructor
			this.patronLocations=custs; 
			this.barpersonLocation = barmanLocation;
