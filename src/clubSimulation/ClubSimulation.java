...
public class ClubSimulation {
	...
	public static void setupGUI(int frameX,int frameY,int [] exits) {
		...
		startB.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e)  {
				...
				synchronized(Clubgoer.started){
					Clubgoer.started.set(true);
					Clubgoer.started.notifyAll(); // Let them know they can COOK ;)
				}
		    }
		   });
	...
	public static void main(String[] args) throws InterruptedException {
		...
		barmanLocation = new PeopleLocation(69);
		barmanLocation.setColor(new Color(200,0,0));
		
		Barman barman = new Barman(clubGrid, barmanLocation);
		Clubgoer.barMan = barman;
